    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <h2 class="h3 mb-2 text-gray-800 profile">{{tr('change_password')}}</h2>
            ...
            <div class="col-md-7 pt-3">
                <a href="{{ route('profile') }}" class="btn btn-primary float-right hidden-sm-down">{{ tr('go_back') }}</a>
            </div>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{tr('change_password')}}</h6>
            </div>

            <div class="card-body">

                <form action="{{route('change_password.save')}}" method="post" enctype="multipart/form-data">
