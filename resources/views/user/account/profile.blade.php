    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <h2 class="h3 mb-2 text-gray-800 profile">{{ tr('profile') }}</h2>
            ...
            <div class="col-md-7">
                ...
                <a href="{{route('profile')}}" class="btn btn-primary float-right hidden-sm-down">
                    {{ tr('go_back') }}
                </a>
            </div>
        </div> 
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <table class="table table-borderless">
                    ...
                    <tr>
                        <td> <a href="{{ route('update_profile') }}" class="btn btn-primary">{{ tr('update_profile') }}</a></td>

                        <td> <a href="{{ route('change_password') }}" class="btn btn-info">{{ tr('change_password') }}</a></td>
